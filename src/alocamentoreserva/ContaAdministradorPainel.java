 ...
 * @author admin
 */
public class ContaAdministradorPainel extends javax.swing.JPanel {
    Administrador administradorLogado = Administrador.logado;
    AdministradorDAO administradorDAO = new AdministradorDAO();
    /**
     * Creates new form ContaAdministradorPainel
     */
    public ContaAdministradorPainel() {
        initComponents();
        
        nomeDeUsuarioTextField.setText(administradorLogado.nomeDeUsuario);
        nomeTextField.setText(administradorLogado.nome);
        senhaTextField.setText(administradorLogado.senha);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Administrador administradorClone = (Administrador) administradorLogado.clone();
            
            administradorClone.nomeDeUsuario = nomeDeUsuarioTextField.getText();
            administradorClone.nome = nomeTextField.getText();
            administradorClone.senha = senhaTextField.getText();
            
            administradorDAO.alterar(administradorLogado, administradorClone);
        } catch (CloneNotSupportedException ex) {
            Logger.getLogger(ContaAdministradorPainel.class.getName()).log(Level.SEVERE, null, ex);
        }
